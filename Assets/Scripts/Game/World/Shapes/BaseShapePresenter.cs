namespace Cubes.Game.World
{
    internal abstract class BaseShapePresenter : IShapePresenter
    {
        ...
        public abstract UnityEngine.RectTransform DraggableShapeParent { get; }
        ...
        public abstract void UpdatePosition(UnityEngine.EventSystems.PointerEventData eventData);
